...
This is an **Experiment** package hosting repo for react native compatibility, please see [Arweave JS](https://github.com/ArweaveTeam/arweave-js) for the origial repo and source.
...
### NPM
```bash
npm install --save nanofuxion/arweave-rn
```
